...
export const metadata = {
  title: "All-on-4/6 Same Day | St Mary’s House Dental Care",
  description: "Premium All-on-4/6 Same Day in Shoreham-by-Sea delivering fixed implant bridges in a single visit for immediate full-arch smiles."
};
  ...
  return (
    <TreatmentLayout
      ...
      <section className="prose prose-invert max-w-3xl my-10 smh-text">
        <p>All-on-4/6 same day treatment places a series of implants and a temporary full-arch bridge in one appointment so you leave with a confident smile immediately.</p>
        <p className="smh-text-dim mt-3">We plan using 3D imaging, collaborate with our lab to create the provisional bridge, and transition you to a refined final restoration once healing completes.</p>
      </section>
