...
export const metadata = {
  title: "The Wand — Painless Numbing | St Mary’s House Dental Care",
  description: "Premium The Wand — Painless Numbing in Shoreham-by-Sea delivering computer-assisted anaesthesia for stress-free dentistry."
};
    ...
    <TreatmentLayout
      ...
      <script type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: treatmentSchemaJSONLD({
          name: "The Wand — Painless Numbing",
          description: "Premium The Wand — Painless Numbing in Shoreham-by-Sea delivering computer-assisted anaesthesia for stress-free dentistry.",
          url: url
        })}} />
      <script type="application/ld+json"
      ...
      <section className="prose prose-invert max-w-3xl my-10 smh-text">
        <p>The Wand delivers anaesthetic through a computer-controlled handpiece, numbing only the area needed with a gentle flow.</p>
        <p className="smh-text-dim mt-3">We pair the technology with reassuring support so your visit stays calm, with little to no lingering numbness once treatment is complete.</p>
      </section>
