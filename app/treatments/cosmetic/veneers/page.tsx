...
export const metadata = {
  title: "Veneers | St Mary’s House Dental Care",
  description: "Premium Veneers in Shoreham-by-Sea designed with digital planning and handcrafted ceramics for radiant, balanced smiles."
};
  ...
  return (
    <TreatmentLayout
      ...
      <section className="prose prose-invert max-w-3xl my-10 smh-text">
        <p>Our veneers transform the smile by refining shade, shape and alignment with ultra-thin ceramic facings customised to every tooth.</p>
        <p className="smh-text-dim mt-3">We design digitally, trial the look with mock-ups and use layered ceramics that capture natural translucency for a luminous, long-lasting finish.</p>
      </section>
