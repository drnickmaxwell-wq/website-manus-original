...
export const metadata = {
  title: "Fixed Braces | St Mary’s House Dental Care",
  description: "Premium Fixed Braces in Shoreham-by-Sea delivering precise tooth movement with contemporary brackets for confident alignment."
};
  ...
  return (
    <TreatmentLayout
      ...
      <section className="prose prose-invert max-w-3xl my-10 smh-text">
        <p>Fixed braces use slender, modern brackets and wires to guide teeth into their ideal positions for balanced function and aesthetics.</p>
        <p className="smh-text-dim mt-3">We plan your bite digitally, fine-tune the adjustments at each review and support you with care tips so treatment stays comfortable and on schedule.</p>
      </section>
