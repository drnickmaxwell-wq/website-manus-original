...
export const metadata = {
  title: "Emergency Dentistry | St Mary’s House Dental Care",
  description: "Premium Emergency Dentistry in Shoreham-by-Sea providing rapid relief, same-day appointments and compassionate care for urgent issues."
};
  ...
  return (
    <TreatmentLayout
      ...
      <section className="prose prose-invert max-w-3xl my-10 smh-text">
        <p>Emergency dentistry at St Mary’s House offers swift, calm support for toothaches, broken teeth and other urgent concerns.</p>
        <p className="smh-text-dim mt-3">We triage quickly, relieve pain and stabilise the problem using advanced diagnostics and restorative techniques to protect your smile.</p>
      </section>
