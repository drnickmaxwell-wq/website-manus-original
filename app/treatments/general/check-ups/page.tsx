...
export const metadata = {
  title: "Check-ups | St Mary’s House Dental Care",
  description: "Premium Check-ups in Shoreham-by-Sea with comprehensive assessments, oral cancer screening and tailored prevention advice."
};
  ...
  return (
    <TreatmentLayout
      ...
      <section className="prose prose-invert max-w-3xl my-10 smh-text">
        <p>Our check-ups combine a thorough clinical examination, gum health review and oral cancer screening to keep your smile at its healthiest.</p>
        <p className="smh-text-dim mt-3">We discuss your goals, review digital records and tailor home-care advice plus follow-up treatments to maintain a bright, comfortable smile.</p>
      </section>
