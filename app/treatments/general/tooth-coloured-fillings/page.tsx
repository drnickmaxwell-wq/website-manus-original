...
export const metadata = {
  title: "Tooth-Coloured Fillings | St Mary’s House Dental Care",
  description: "Premium Tooth-Coloured Fillings in Shoreham-by-Sea restoring teeth with high-strength composites that blend seamlessly." 
};
  ...
  return (
    <TreatmentLayout
      ...
      <section className="prose prose-invert max-w-3xl my-10 smh-text">
        <p>Tooth-coloured fillings repair cavities and chips with durable composite matched perfectly to your natural enamel.</p>
        <p className="smh-text-dim mt-3">We isolate the tooth, layer the composite for strength and polish it to a high lustre so the restoration disappears within your smile.</p>
      </section>
