  ...
  return (
    <>
      <section className="relative overflow-hidden">
        <BrandHeroGradient intensity="standard" waveOpacity={0.2} goldDensity="med" goldRimEnabled>
          <div className="container mx-auto px-6 py-20 md:py-28 text-white">
            <span className="inline-flex items-center rounded-full border px-4 py-1 text-sm/6 backdrop-blur-md"
              style={{ borderColor: "color-mix(in oklab, var(--smh-accent-gold) 60%, transparent)" } as React.CSSProperties}
            >
              AI-Powered 3-D Dentistry
            </span>
            <h1 className="mt-6 font-serif text-4xl md:text-6xl leading-tight drop-shadow-[0_1px_0_rgba(0,0,0,.06)]">
