    ...
    <section className="relative my-10 rounded-2xl smh-glass">
      <div className="p-6 md:p-8">
        ...
        <p className="smh-text-dim mt-2 max-w-2xl">
          Spread the cost with flexible monthly plans, including interest-free options (subject to status).
        </p>
        <div className="mt-4"><a href="/fees" className="smh-btn">Check eligibility</a></div>
      </div>
    </section>
  );
}
